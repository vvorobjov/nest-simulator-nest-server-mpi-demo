 ...
 *
 *  Generated from NESTML at time: 2025-04-25 10:07:20.577698
**/
...
{
#ifdef DEBUG
  std::cout << "[neuron " << this << "] basic_neuron_nestml::init_state_internal_()" << std::endl;
#endif
...
{
#ifdef DEBUG
  std::cout << "[neuron " << this << "] basic_neuron_nestml::init_buffers_()" << std::endl;
#endif
  // spike input buffers
...
{
#ifdef DEBUG
  std::cout << "[neuron " << this << "] basic_neuron_nestml::pre_run_hook()" << std::endl;
#endif
...
#ifdef DEBUG
    std::cout << "[neuron " << this << "] basic_neuron_nestml::update: handling post spike at t = " << get_t() << std::endl;
#endif
    /**
...
{
#ifdef DEBUG
  std::cout << "[neuron " << this << "] basic_neuron_nestml::handle(SpikeEvent)" << std::endl;
#endif
